    ...
    <div>
      ...
      <div className="about-nike-part">
        ...
        <p className='about-nike-para'>
          ...
          creative and derivatives global team and by making a positive impact in
          communities where cascade live and work. Based in Beaverton, Oregon, NIKE,
          Inc. including this the Nike, Converse, and Jordan brands.
        </p>
      </div>
    </div>
  );
